...
class FigshareDownloader(BaseDownloader):
    ...
    def download(
        ...
        *,
        ...
        try:
            ...
            return HTTPDownloader.download(download_url, target_path, show_progress=show_progress)

        except Exception as e:
            raise DownloadError(f"Failed to download Figshare file {file_id}: {e}")
    ...
    def download_from_url(
        ...
        *,
        ...
        try:
            return HTTPDownloader.download(url, target_path, show_progress=show_progress)
        except Exception as e:
    ...
    def download_article(
        ...
        *,
        ...
        try:
            ...
            logger.info(f"Downloading Figshare article {article_id} ({len(files)} files)")
            ...
            for file_info in files:
                ...
                HTTPDownloader.download(
                    file_info["download_url"], file_path, show_progress=show_progress
                )
            ...
            raise DownloadError(f"Failed to download article {article_id}: {e}")

    @staticmethod
    def get_file_info(file_id: str | int, *, token: str | None = None) -> dict[str, Any]:
    ...
    def get_article_files(
        article_id: str | int, *, token: str | None = None
    ) -> list[dict[str, Any]]:
        ...
        try:
            ...
            raise DownloadError(f"Failed to get article files for {article_id}: {e}")
