...
from ._cell import CellDataset, DuplicatedGenePolicy
...
class PerturbationDataset(CellDataset):
    ...
    @classmethod
    def _initialize(cls) -> 'PerturbationDataset':
        ...
        instance = super(PerturbationDataset, cls)._initialize()
    ...
    def _create_from_existing(self, new_adata: ad.AnnData) -> 'PerturbationDataset':
        """Override to preserve perturbation attributes when creating from existing AnnData."""
        instance = self._initialize()
        ...
        instance.control_labels = self.control_labels
        instance.ignore_labels = self.ignore_labels
    ...
    def split(
        ...
        split_col: str = 'split',
        **kwargs
    ) -> Union['PerturbationDataset', Dict[str, 'PerturbationDataset']]:
        """
    ...
    def calculate_de(
        ...
        **kwargs
        ...
        if use_scanpy:
            ...
            from perturblab.data.process import rank_genes_groups
