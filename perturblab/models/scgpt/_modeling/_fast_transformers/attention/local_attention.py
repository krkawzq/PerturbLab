...
class LocalAttention(Module):
    ...
    def __init__(
        self, local_context, softmax_temp=None, attention_dropout=0.1, event_dispatcher=""
    ):
    ...
    def forward(self, queries, keys, values, attn_mask, query_lengths, key_lengths):
        ...
        QK = local_dot_product(
            queries, keys, attn_mask.additive_matrix_finite, key_lengths.lengths, self.local_context
        )
