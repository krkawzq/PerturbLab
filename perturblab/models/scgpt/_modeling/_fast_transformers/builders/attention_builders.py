...
class BaseAttentionBuilder(BaseBuilder):
    ...
    def validate_attention_type(self, attention_type):
        ...
        return all(
            all(t in self._registry for t in a.split(",")) for a in attention_type.split(":")
        )
    ...
    def _construct_attention(self, attention_type, decorated=[]):
        ...
        parameter_dictionary = {
            p: self._registry.validate_parameter(p, self._parameters[p]) for p in parameters
        }
...
class RecurrentAttentionBuilder(BaseAttentionBuilder):
    ...
    def __init__(self):
        super(RecurrentAttentionBuilder, self).__init__(RecurrentAttentionRegistry)
...
class RecurrentCrossAttentionBuilder(BaseAttentionBuilder):
    ...
    def __init__(self):
        super(RecurrentCrossAttentionBuilder, self).__init__(RecurrentCrossAttentionRegistry)
