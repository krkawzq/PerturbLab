...
class FinetuneModel(nn.Module):
    ...
    def __init__(self, n_genes: int, cfg: Any):
        ...
        self.reconstruct2 = MaskedMSE(tag='_ce') # Cell Expression loss (unused in forward but kept)
    ...
    def embedding_infer(
        ...
        if ST_feat is None:
            ...
            raise NotImplementedError("Inference with ST_feat is not fully supported in embedding_infer yet.")
